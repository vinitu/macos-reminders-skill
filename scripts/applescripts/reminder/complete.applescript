on run argv
    if (count of argv) is less than 2 then error "Usage: osascript scripts/applescripts/reminder/complete.applescript <list-name> <reminder-name>"
    ...
    tell application "Reminders"
        set targetList to first list whose name is listName
        tell first reminder of targetList whose id is reminderId
