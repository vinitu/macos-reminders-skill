on run argv
    ...
    if (count of args) is less than 2 then error "Usage: osascript scripts/list/search.applescript <exact-name|id|color|emblem|text> <query> [account-name] [--format=plain|json]"
