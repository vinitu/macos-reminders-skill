...
if [[ -n "$list_name" ]]; then
  run_reminder_applescript today-or-overdue.applescript "$list_name" | augment_reminders_json
else
  run_reminder_applescript today-or-overdue.applescript | augment_reminders_json
fi
