on run argv
    ...
    if (count of args) is less than 3 then error "Usage: osascript scripts/reminder/move-by-id.applescript <source-list-name> <reminder-id> <target-list-name> [--format=plain|json]"
