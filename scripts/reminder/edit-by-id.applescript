on run argv
    ...
    if (count of args) is less than 4 then error "Usage: osascript scripts/reminder/edit-by-id.applescript <list-name> <reminder-id> <property> <value> [--format=plain|json]"
