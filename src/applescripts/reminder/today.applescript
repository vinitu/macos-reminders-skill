on run argv
    ...
    if (count of args) is greater than 1 then error "Usage: osascript src/applescripts/reminder/today.applescript [list-name] [--format=plain|json]"
    ...
    set hits to my collectDueWindow(listName, startOfToday, startOfTomorrow, true)
