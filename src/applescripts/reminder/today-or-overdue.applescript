on run argv
    ...
    if (count of args) is greater than 1 then error "Usage: osascript src/applescripts/reminder/today-or-overdue.applescript [list-name] [--format=plain|json]"
    ...
    set hits to my collectDueBefore(listName, startOfTomorrow, true)
