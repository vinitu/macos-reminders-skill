on run argv
    ...
    if (count of args) is less than 2 then error "Usage: osascript src/applescripts/reminder/due-range.applescript <start-date-text> <end-date-text> [list-name] [--format=plain|json]"
